 ...
 */
@Component({
  selector: 'app-button-fe-button',
  templateUrl: './buttonfe-button.component.html',
  styleUrls: [],
  standalone: true,
  imports: [CommonModule]
})
export class buttonFeButtonComponent implements AfterViewInit {
  ...
  private applyInitialDomEnhancements(): void {
    ...
    this.nativeElement.setAttribute('data-component', 'button-fe-button');
