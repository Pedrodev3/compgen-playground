 ...
 */
@Component({
  selector: 'app-button-cp-button',
  templateUrl: './buttoncp-button.component.html',
  styleUrls: [],
  standalone: true,
  imports: [CommonModule]
})
export class buttonCpButtonComponent implements AfterViewInit {
  ...
  private applyInitialDomEnhancements(): void {
    ...
    this.nativeElement.setAttribute('data-component', 'button-cp-button');
